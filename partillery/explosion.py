...
class Explosion():
    def __init__(self, screen, playsurfbk, center, radius, ammo_type):
        t = 0
        ...
        speed = 0.35  # pixels per 1000 ms

        while speed * t < radius * 2 / 2:  # milliseconds
